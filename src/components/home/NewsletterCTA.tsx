    ...
    <section className="container mx-auto px-4 py-20">
      <div className="relative rounded-2xl overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 right-1/3 w-72 h-72 bg-primary/8 rounded-full blur-[100px]" />
          <div className="absolute bottom-0 left-1/3 w-72 h-72 bg-accent/6 rounded-full blur-[100px]" />
        </div>
